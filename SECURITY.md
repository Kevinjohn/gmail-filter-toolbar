...
Once a vulnerability has been reported and a fix has been developed and deployed, we will publicly disclose the vulnerability and credit the reporter (unless they wish to remain anonymous).

## Supported Versions

We only provide security updates for the latest stable release of the project. Please ensure you are using the most recent version to receive all security patches.
